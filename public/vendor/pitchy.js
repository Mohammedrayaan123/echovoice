// Vendored from npm `pitchy` v4.1.0 (MIT, Ian Johnson) for the same reason as
// ./fft.js — see that file's header. Only change from the published source:
// the "fft.js" bare import below now points at the vendored copy.
